...
protected void onCreate(Bundle savedInstanceState) {
	...
	countDown=	new CountDownTimer(10000, 1000) {
	     ...
	     public void onFinish() {
	    	 ...
	    	 tvTipsMessage.setText(Html.fromHtml("Please Check SMS for <br/> the OTP !!").toString());
	     }
	  }.start();
	                    ...
	                    if (bundle != null)
	                    {
	                      ...
	                      for (SmsMessage message : messages)
	                      {
	                    	  Utils.log("Message","Received Number :"+message.getDisplayOriginatingAddress());
	                            if(message.getDisplayOriginatingAddress().contains("SRINET")&& message.getMessageBody().contains("Shreenet")&& message.getMessageBody().contains("OTP")){
